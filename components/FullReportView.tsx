                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    {reportSections.map((section) => (
                        <div 
                            ...
                            className="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 p-6 cursor-pointer group flex flex-col h-full"
                        >
